...
export async function GET(
  ...
  try {
    ...
    // Resolve the full path to the file within the Medusa/manga directory
    const filePath = path.join(process.cwd(), 'Medusa', 'manga', relativePath);

    console.log('Serving manga file from path:', filePath);
    ...
    try {
      ...
      console.error('Manga file not found:', filePath);
    ...
    console.error('Error serving manga file:', error);
