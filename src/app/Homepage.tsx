  ...
  return (
    <>
      ...
      <ResponsiveLayout>
        ...
        {/* Social Sharing Section - Only show if homesocialbuttons is true */}
        {siteSettings.homesocialbuttons && (
              ...
              <div className="animate-fadeInDelayed bg-[#0f1014] rounded-xl shadow-lg border border-gray-800/30 overflow-hidden transition-all duration-300 hover:border-[#5865F2] hover:shadow-[0_0_15px_rgba(88,101,242,0.3)] group">
                <div className="flex flex-row items-center justify-between p-4">
                  ...
                  <a 
                    ...
                    className="hover:scale-105 active:scale-95 px-6 py-2.5 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-full flex items-center justify-center gap-2 transition-all duration-300 shadow-lg"
                  >
              ...
              <div className="animate-fadeInDelayed bg-[#0f1014] rounded-xl shadow-lg border border-gray-800/30 overflow-hidden transition-all duration-300 hover:border-[#FF5E5B] hover:shadow-[0_0_15px_rgba(255,94,91,0.3)] group">
                <div className="flex flex-row items-center justify-between p-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="hover:scale-105 active:scale-95 px-6 py-2.5 bg-[#FF5E5B] hover:bg-[#FF7C79] text-white rounded-full flex items-center justify-center gap-2 transition-all duration-300 shadow-lg"
                  >
        ...
        {/* Latest Comics Section - Wrapped in Suspense and using memoized component */}
