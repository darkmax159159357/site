...
const SignUp = () => {
  ...
  const { register, onSubmit, handleSubmit, errors, isSubmitting, signUpError, isLoading } =
    useSignUp();
  return (
    <>
      <div className="mt-10 ">
        ...
        <center>
          <div className="">
            {signUpError && (
              <div className="bg-red-700/40 border border-red-700 text-white p-3 rounded-md mt-4 text-sm">
                {signUpError}
              </div>
            )}
            <form
